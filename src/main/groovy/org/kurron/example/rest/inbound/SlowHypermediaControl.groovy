...
class SlowHypermediaControl extends ResourceSupport {

    /**
     * The expected MIME type for the control.
     */
    public static final String MIME_TYPE = 'application/json;type=slow;version=1.0.0'
